...
function generatePassword(string1, string2) {
  let code = '';
string1 = input.question('first string? ')
string2 = input.question('second string? ')
while(string2.length != string1.length){
  console.log("both strings must match in length, please input a string of same length as first string")
  string2 = input.question('second string? ')
}
